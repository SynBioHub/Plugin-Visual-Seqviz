import HookSelector from '../rendering/HookSelector';
/**
    ...
    placeHook(display) {
        ...
        if (this.destinationGlyph) {
            ...
            if (this.direction === 'north') {
                ...
                console.log('destination glyph', this.destinationGlyph.coords);
            }
        }
    ...
    getTip() {
        switch (this.direction) {
            ...
            case 'north': {
                return {
                    x: this.start.x,
                    y: this.start.y + this.length + this.startGlyph.inset
                };
            }
            default: {
                return {
